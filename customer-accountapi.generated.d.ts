...
type DiscountApplication_ManualDiscountApplication_Fragment = Pick<
...
type DiscountApplication_ScriptDiscountApplication_Fragment = Pick<
...
> & {
  ...
  billingAddress?: CustomerAccountAPI.Maybe<
    Pick<
      CustomerAccountAPI.CustomerAddress,
      'id' | 'name' | 'formatted' | 'formattedArea'
    >
  >;
...
export type OrderItemFragment = Pick<
  CustomerAccountAPI.Order,
  'name' | 'id' | 'number' | 'processedAt' | 'financialStatus'
> & {
  fulfillments: {
    nodes: Array<
      Pick<
      ...
      > & {
        trackingInformation: Array<
          Pick<CustomerAccountAPI.TrackingInformation, 'number' | 'url'>
        >;
      }
    >;
  };
  ...
  customerUpdate?: CustomerAccountAPI.Maybe<{
    customer?: CustomerAccountAPI.Maybe<
      Pick<CustomerAccountAPI.Customer, 'firstName' | 'lastName'> & {
        ...
        >;
        defaultAddress?: CustomerAccountAPI.Maybe<
          Pick<CustomerAccountAPI.CustomerAddress, 'phoneNumber'>
        >;
      }
    >;
    userErrors: Array<
