...
export type AdminProductTitleSearchQueryVariables = AdminTypes.Exact<{
  query: AdminTypes.Scalars['String']['input'];
}>;


export type AdminProductTitleSearchQuery = { products: { edges: Array<{ node: Pick<AdminTypes.Product, 'id' | 'handle' | 'title'> }> } };
...
export type AdminVariantSearchQueryVariables = AdminTypes.Exact<{
  query: AdminTypes.Scalars['String']['input'];
}>;


export type AdminVariantSearchQuery = { productVariants: { edges: Array<{ node: (
        Pick<AdminTypes.ProductVariant, 'id' | 'displayName'>
        & { product: Pick<AdminTypes.Product, 'id' | 'handle' | 'title'> }
      ) }> } };
...
interface GeneratedQueryTypes {
  ...
  "#graphql\n  query AdminProductTitleSearch($query: String!) {\n    products(first: 10, query: $query) {\n      edges {\n        node {\n          id\n          handle\n          title\n        }\n      }\n    }\n  }\n": {return: AdminProductTitleSearchQuery, variables: AdminProductTitleSearchQueryVariables},
  ...
  "#graphql\n  query AdminVariantSearch($query: String!) {\n    productVariants(first: 10, query: $query) {\n      edges {\n        node {\n          id\n          displayName\n          product {\n            id\n            handle\n            title\n          }\n        }\n      }\n    }\n  }\n": {return: AdminVariantSearchQuery, variables: AdminVariantSearchQueryVariables},
}
