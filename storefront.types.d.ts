...
export type ConsentManagementBanner = {
  ...
  /** Experiment related fields of the banner. */
  experiment?: Maybe<ConsentManagementBannerExperiment>;
  /** Whether the merchant changed or not any banner field from its default value. */
...
/** Represents experiment strings for the privacy banner. */
export type ConsentManagementBannerExperiment = {
  __typename?: 'ConsentManagementBannerExperiment';
  /** Experiment banner customize text. */
  customizeYour?: Maybe<Scalars['String']['output']>;
  /** Experiment banner preferences text. */
  preferences?: Maybe<Scalars['String']['output']>;
  /** Experiment banner privacy policy text. */
  privacyPolicy?: Maybe<Scalars['String']['output']>;
  /** Experiment banner title text. */
  title?: Maybe<Scalars['String']['output']>;
};
...
export type MetafieldParentResource = Article | Blog | Cart | Collection | Company | CompanyLocation | Customer | GateConfiguration | Location | Market | Order | Page | Product | ProductVariant | SellingPlan | Shop;
...
export type Mutation = {
  ...
  /** Removes personal identifiable information from the cart. */
